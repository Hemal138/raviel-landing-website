...
const HomeCard = () => {
  ...
  scrollTrigger: {
    ...
    // card 3 moving
    tl.to(card1Ref.current, { y: -500, opacity: 0, duration: 5 });
    tl.to(card2Ref.current, { y: -500, opacity: 0, duration: 5 });
    tl.to(card3Ref.current, { y: -500, opacity: 0, duration: 5 });
    tl.to(card4Ref.current, { y: -500, opacity: 0, duration: 5 });
    tl.to(card5Ref.current, { y: -500, opacity: 0, duration: 5 });
    // tl.to(card6Ref.current, { y: -500, opacity: 0, duration: 5 });
  });
